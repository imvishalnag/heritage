        ...
        <div class="row">
          ...
          <div class="col-md-6 offset-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('gallery.individual.update', ['id' => $id])}}" method="post" role="form" enctype="multipart/form-data" id="form">
                @method('PUT')
                @csrf
               <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input  type="text" class="form-control" placeholder="Enter Caption" name="caption" value="{{old('caption') ?? $caption}}" required="">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        <img id="old_file" src="{{asset('assets/gallery/individual/'.$file.'')}}" alt="" width="100%">
