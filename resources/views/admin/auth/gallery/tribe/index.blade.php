...
<div class="content-wrapper" style="min-height: 1244.06px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Gallery Tribe Cover Upload Form</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-6 offset-md-3">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Upload Tribe Cover</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('gallery.state.tribe.store')}}" method="post" role="form" enctype="multipart/form-data" id="form">
                @method('PUT')
                @csrf
               <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <small class="text-warning">*It will update if already uploaded!</small>
                    </div>
                  </div>
                   <div class="col-md-6">
                    <div class="form-group">
