        ...
        <div class="row">
          ...
          <div class="col-md-6 offset-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('plan.store')}}" method="post" role="form" id="form">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input  type="text" class="form-control" placeholder="Plan Name" name="title" value="{{old('title')}}" required="">
                          @if($errors->has('title'))
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <textarea name="description" class="form-control" placeholder="Enter Plan Description">{{ old('description') }}</textarea>  
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea name="rule" class="form-control" placeholder="Enter Plan Rule">{{ old('rule') }}</textarea>  
                          @if($errors->has('rule'))
                            <span class="invalid-feedback" role="alert" style="color:red">
                        ...
                        <div class="form-group">
                          ...
                          <input  type="number" class="form-control" placeholder="Price" name="price" value="{{old('price')}}" required="">
                          @if($errors->has('price'))
                            <span class="invalid-feedback" role="alert" style="color:red">
