...
<div class="content-wrapper" style="min-height: 1244.06px;">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>YouTube Video Update Form</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-6 offset-md-3">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update YouTube Video</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('youtube_video.update', ['id' => $id])}}" method="post" role="form" enctype="multipart/form-data" id="form">
                @method('PUT')
                @csrf
               <div class="card-body">
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <input  type="text" class="form-control" placeholder="Enter 11 digit video code (see below screenshot for reference)" name="code" value="{{old('code') ?? $code}}" required="">
                      @if($errors->has('code'))
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <input type="text" class="form-control" name="heading" value="{{old('heading') ?? $heading}}" placeholder="Enter video heading" required="">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        <img id="old_file" src="{{asset('assets/youtubevideo/'.$file.'')}}" alt="" width="100%">
