          ...
          <div class="col-md-6 offset-md-3">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Update Publication Data</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('publication.update', ['id' => $id])}}" method="post" role="form" enctype="multipart/form-data" id="form">
                @method('PUT')
                @csrf
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <img id="old_file" src="{{asset('assets/publication/'.$file.'')}}" alt="" width="100%">
